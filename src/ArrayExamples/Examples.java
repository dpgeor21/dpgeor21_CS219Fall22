...
public class Examples {
    ...
    // reverses an array. Modify actuall array "arr"

    public static int[] reverse(int [] arr){ // functions that return values can be composed
    ...
    public static int index_of(final String [] arr, String item) {
        for (int i = 0; i < arr.length; i++) {
    ...
    public static void main(String [] args){
        ...
        System.out.println(index_of(names, "Ron") == 2);
